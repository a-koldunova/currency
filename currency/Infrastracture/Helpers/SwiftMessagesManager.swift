...
protocol SwiftMessagesManager : AnyObject {
    func showMessages(theme : Theme, withTitle title : String, withMessage message : String, isForeverDuration : Bool, actionText : String?, action : (() -> Void)?)
...
extension SwiftMessagesManager {
    ...
    func showMessages(theme : Theme, withTitle title : String = "Error", withMessage message : String, isForeverDuration : Bool, actionText : String?, action : (() -> Void)?) {
